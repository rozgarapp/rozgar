      ...
      <footer className="mt-auto w-full" style={{ background: "#1B4332", color: "#D1FAE5" }}>
        <div className="max-w-5xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              <Link to="/" className="text-base font-bold mb-1 hover:text-white transition-colors" style={{ color: "#fff" }}>
        ...
        <div className="border-t px-4 py-4 text-center" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
          ...
          <p className="text-xs text-green-500 mt-1">
            Contact: <a href="mailto:rozgarapp2026@gmail.com" className="underline hover:text-white">rozgarapp2026@gmail.com</a>
          </p>
        </div>
      </footer>
    </>
