...
const sections = [
  { title: "1. Who We Are", content: `Rozgar Platform provides a way for skilled workers and employers to connect. This Privacy Policy explains how we collect, use, store, and protect your personal data when you use Rozgar. For any privacy-related questions, contact us at rozgarapp2026@gmail.com.` },
  ...
  { title: "5. Google AdMob & Third-Party Advertising", content: `Rozgar uses Google AdMob to display advertisements. Google may use cookies and device identifiers to show you personalised ads based on your interests. You can opt out of personalised ads by visiting Google's Ad Settings at adssettings.google.com. We are not responsible for data collected by Google AdMob under their own privacy policy.` },
  { title: "6. Cookies & Local Storage", content: `Rozgar uses browser local storage to keep you logged in and remember your language preference. We do not use tracking cookies for marketing purposes. Third-party services such as Google AdMob may set their own cookies on your device.` },
  { title: "7. Data Retention", content: `We retain your personal data for as long as your account is active. If you delete your account, your data will be removed from our active systems within 30 days. Some data may be retained longer where required by Indian law or for legitimate business purposes such as dispute resolution.` },
  ...
  { title: "9. Data Security", content: `We implement industry-standard security measures to protect your data including HTTPS encryption, JWT-based authentication, and secure database storage. However, no system is completely secure and we cannot guarantee absolute security of your data transmitted over the internet.` },
  { title: "10. Children's Privacy", content: `Rozgar is not intended for use by anyone under the age of 18. We do not knowingly collect personal data from minors. If we become aware that a minor has registered, we will delete their account and data immediately.` },
  { title: "11. Compliance with Indian Law", content: `This Privacy Policy is compliant with the Information Technology Act, 2000 and the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011. We are committed to complying with applicable Indian data protection laws including the Digital Personal Data Protection Act, 2023.` },
  { title: "12. GDPR & GCC Users (For International Users)", content: `If you access Rozgar from the European Union, United Kingdom, or GCC countries (UAE, Saudi Arabia, Qatar, Kuwait, Bahrain, Oman), you may have additional data protection rights, including the right to access, correct, or delete your data, data portability, and the right to object to processing. We process your data based on your consent at registration and our legitimate interest in operating the platform.` },
  { title: "13. Changes to This Policy", content: `We may update this Privacy Policy from time to time. We will notify you of significant changes via the platform or email. Continued use of Rozgar after changes constitutes your acceptance of the updated policy.` },
  { title: "14. Contact Us", content: `For any privacy-related questions or requests, please contact us at:\n\nRozgar Platform\nEmail: rozgarapp2026@gmail.com` },
];
